 ...
 * @param {string} [gameName='tango'] - Game identifier for uniqueness
 * @returns {number} Positive integer seed
 *
 * @example
 *   dateSeed('2026-04-18', 'tango');  // always returns the same integer
 *   dateSeed('2026-04-19', 'tango');  // different integer
 *   dateSeed('2026-04-18', 'queens'); // different from tango's seed
 */
 ...
 * @example
 *   const rng = createRNG(42);
 *   shuffle([1, 2, 3, 4, 5], rng); // deterministic shuffle
 */
