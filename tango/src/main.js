/**
 * LinkedIn Games App — Single entry point for all games.
 * Hub + Tango + Queens, all on one server.
 */
...
const GAMES = [
  { id: 'tango',  name: 'Tango',  icon: '☀️', gradient: 'linear-gradient(135deg, #FFD54F, #B39DDB)', route: '/tango', available: true },
  { id: 'queens', name: 'Queens', icon: '👑', gradient: 'linear-gradient(135deg, #F4A0B5, #B39DDB)', route: '/queens', available: true },
  { id: 'sudoku', name: 'Sudoku', icon: '🔢', gradient: 'linear-gradient(135deg, #64B5F6, #4DD0E1)', route: null, available: false },
  { id: 'zip',    name: 'Zip',    icon: '🔗', gradient: 'linear-gradient(135deg, #FFB74D, #E74C3C)', route: null, available: false },
];
