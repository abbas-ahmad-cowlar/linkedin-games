...
const GAMES = [
  { id: 'queens', name: 'Queens', icon: '👑', gradient: 'linear-gradient(135deg, #F4A0B5, #B39DDB)', available: true },
  { id: 'tango',  name: 'Tango',  icon: '☀️', gradient: 'linear-gradient(135deg, #FFD54F, #B39DDB)', available: false },
